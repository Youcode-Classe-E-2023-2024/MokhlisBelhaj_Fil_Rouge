...
<section class="flex flex-col md:flex-row h-screen items-center"
    ...
    <div class=" hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
        {{-- <img src="https://images.unsplash.com/photo-1615184697985-c9bde1b07da7?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" class="w-full h-full object-cover"> --}}
    </div>

    <div
        class=" w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div class="w-full h-100">
            ...
            <h1 class="text-xl md:text-4xl text-white font-bold leading-tight mt-12 text-3d">Log in to your account</h1>
